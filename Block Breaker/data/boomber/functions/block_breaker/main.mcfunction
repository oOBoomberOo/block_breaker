...
execute as @e[type=area_effect_cloud,tag=boomber.block_breaker.leftover_block,nbt={Age:2}] at @s if block ~ ~ ~ white_stained_glass run fill ~ ~ ~ ~ ~ ~ air replace
execute as @e[type=area_effect_cloud,tag=boomber.block_breaker.leftover_block,nbt={Age:2}] at @s if block ~ ~ ~ red_stained_glass run fill ~ ~ ~ ~ ~ ~ air replace
execute as @e[type=area_effect_cloud,tag=boomber.block_breaker.leftover_block,nbt={Age:2}] run kill @s
